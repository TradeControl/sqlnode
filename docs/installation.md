...
Install the [BOM Tutorial](https://github.com/tradecontrol/sqlnode) using the Database Configurator. Follow the instructions until you get to the screen below. If you want, you can replace the fiat payment system with a [bitcoin wallet](https://github.com/tradecontrol/bitcoin).
...
Install the [Services Tutorial](https://github.com/tradecontrol/sqlnode) using the Database Configurator. Follow the instructions until you get to the screen below.

![Tutorial Install](../images/services_install.png)

Select the Pay Invoices option first, then try out the other options at the end of the tutorial.
