CREATE TABLE [App].[tbYearPeriod] (
    ...
    [TaxAdjustment]      MONEY         CONSTRAINT [DF_App_tbYearPeriod_TaxAdjustment] DEFAULT ((0)) NOT NULL,
    [VatAdjustment]      MONEY         CONSTRAINT [DF_App_tbYearPeriod_VatAdjustment] DEFAULT ((0)) NOT NULL,
