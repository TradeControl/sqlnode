...
go
PRINT N'Creating Index [Subject].[tbSubject].[IX_Subject_tb_AccountSource]...';
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_Subject_tbAddress]
    ON [Subject].[tbAddress]([AccountCode] ASC, [AddressCode] ASC) WITH (FILLFACTOR = 90);
...
go
PRINT N'Creating Foreign Key [Usr].[Usr_tbMenuEntry_FK01]...';


go
ALTER TABLE [Usr].[tbMenuEntry]
    ADD CONSTRAINT [Usr_tbMenuEntry_FK01] FOREIGN KEY ([Command]) REFERENCES [Usr].[tbMenuCommand] ([Command]);


go
PRINT N'Creating Foreign Key [Usr].[Usr_tbMenuEntry_FK02]...';


go
ALTER TABLE [Usr].[tbMenuEntry]
    ADD CONSTRAINT [Usr_tbMenuEntry_FK02] FOREIGN KEY ([OpenMode]) REFERENCES [Usr].[tbMenuOpenMode] ([OpenMode]);
...
go
PRINT N'Creating Foreign Key [Project].[Object_tb_FK00]...';


go
ALTER TABLE [Project].[tbProject]
    ADD CONSTRAINT [Object_tb_FK00] FOREIGN KEY ([ObjectCode]) REFERENCES [Object].[tbObject] ([ObjectCode]) ON UPDATE CASCADE;


go
PRINT N'Creating Foreign Key [Project].[Object_tb_FK01]...';


go
ALTER TABLE [Project].[tbProject]
    ADD CONSTRAINT [Object_tb_FK01] FOREIGN KEY ([ProjectStatusCode]) REFERENCES [Project].[tbStatus] ([ProjectStatusCode]);


go
PRINT N'Creating Foreign Key [Project].[Object_tb_FK02]...';


go
ALTER TABLE [Project].[tbProject]
    ADD CONSTRAINT [Object_tb_FK02] FOREIGN KEY ([AccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]) ON UPDATE CASCADE;
...
go
ALTER TABLE [Project].[tbAllocation]
    ADD CONSTRAINT [FK_Project_tbAllocation_AccountCode] FOREIGN KEY ([AccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE [Subject].[tbSector]
    ADD CONSTRAINT [FK_Subject_tbSector_Subject_tb] FOREIGN KEY ([AccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]) ON DELETE CASCADE ON UPDATE CASCADE;
...
go
ALTER TABLE [Subject].[tbDoc]
    ADD CONSTRAINT [FK_Subject_tbDoc_AccountCode] FOREIGN KEY ([AccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]) ON DELETE CASCADE ON UPDATE CASCADE;
...
go
ALTER TABLE [Subject].[tbContact]
    ADD CONSTRAINT [FK_Subject_tbContact_AccountCode] FOREIGN KEY ([AccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]) ON DELETE CASCADE ON UPDATE CASCADE;
...
go
ALTER TABLE [Subject].[tbAddress]
    ADD CONSTRAINT [FK_Subject_tbAddress_Subject_tb] FOREIGN KEY ([AccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE [Subject].[tbAccountKey]
    ADD CONSTRAINT [FK_Subject_tbAccountKey_Subject_tbAccount] FOREIGN KEY ([CashAccountCode]) REFERENCES [Subject].[tbAccount] ([CashAccountCode]) ON DELETE CASCADE ON UPDATE CASCADE;
...
go
ALTER TABLE [Subject].[tbAccount]
    ADD CONSTRAINT [FK_Subject_tbAccount_Subject_tb] FOREIGN KEY ([AccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]) ON UPDATE CASCADE;
...
go
ALTER TABLE [Invoice].[tbEntry]
    ADD CONSTRAINT [FK_Invoice_tbEntry_Subject_tb] FOREIGN KEY ([AccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]);
...
go
ALTER TABLE [Invoice].[tbInvoice]
    ADD CONSTRAINT [FK_Invoice_tb_Subject_tb] FOREIGN KEY ([AccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]);
...
go
ALTER TABLE [Invoice].[tbMirror]
    ADD CONSTRAINT [FK_Invoice_tbMirror_tbSubject] FOREIGN KEY ([AccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]);
...
go
ALTER TABLE [Cash].[tbPayment]
    ADD CONSTRAINT [FK_Cash_tbPayment_Subject_tbAccount] FOREIGN KEY ([CashAccountCode]) REFERENCES [Subject].[tbAccount] ([CashAccountCode]) ON UPDATE CASCADE;
...
go
ALTER TABLE [Cash].[tbPayment]
    ADD CONSTRAINT [FK_Cash_tbPayment_tbSubject] FOREIGN KEY ([AccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]);
...
go
ALTER TABLE [Cash].[tbChange]
    ADD CONSTRAINT [FK_Cash_tbChange_Subject_tbAccountKey] FOREIGN KEY ([CashAccountCode], [HDPath]) REFERENCES [Subject].[tbAccountKey] ([CashAccountCode], [HDPath]) ON DELETE CASCADE ON UPDATE CASCADE;
...
go
ALTER TABLE [Cash].[tbTaxType]
    ADD CONSTRAINT [FK_Cash_tbTaxType_Subject_tb] FOREIGN KEY ([AccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]) ON UPDATE CASCADE;
...
go
ALTER TABLE [Cash].[tbMirror]
    ADD CONSTRAINT [FK_Cash_tbMirror_tbSubject] FOREIGN KEY ([AccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]);
...
go
PRINT N'Creating Foreign Key [App].[App_tbCalendarHoliday_FK00]...';


go
ALTER TABLE [App].[tbCalendarHoliday]
    ADD CONSTRAINT [App_tbCalendarHoliday_FK00] FOREIGN KEY ([CalendarCode]) REFERENCES [App].[tbCalendar] ([CalendarCode]) ON DELETE CASCADE ON UPDATE CASCADE;
...
go
ALTER TABLE [App].[tbOptions]
    ADD CONSTRAINT [FK_App_tbOptions_Subject_tb] FOREIGN KEY ([AccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]) ON UPDATE CASCADE;
...
go
ALTER TABLE [App].[tbOptions]
    ADD CONSTRAINT [FK_App_tbOptions_Subject_tbSubject] FOREIGN KEY ([MinerAccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]);
...
go
ALTER TABLE [Object].[tbMirror]
    ADD CONSTRAINT [FK_Object_tbMirror_tbSubject] FOREIGN KEY ([AccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]) ON DELETE CASCADE ON UPDATE CASCADE;
...
AS
	SELECT        Project.tbFlow.ParentProjectCode, Project.tbFlow.StepNumber, Project.tbProject.ProjectCode, Project.tbProject.ObjectCode, Project.tbProject.ProjectTitle, Project.tbProject.ProjectNotes, Project.tbStatus.ProjectStatus, Project.tbProject.ActionOn, 
							 Project.tbProject.Quantity, Project.tbProject.ActionedOn, Subject.tbSubject.AccountCode, Usr.tbUser.UserName AS Owner, tbUser_1.UserName AS ActionBy, Subject.tbSubject.AccountName, Project.tbProject.UnitCharge, 
	...
	FROM            Usr.tbUser AS tbUser_1 INNER JOIN
							 ...
							 Subject.tbSubject ON Project.tbProject.AccountCode = Subject.tbSubject.AccountCode ON tbUser_1.UserId = Project.tbProject.ActionById INNER JOIN
...
AS
	SELECT        sales_order.ProjectCode, sales_order.ContactName, Subject.tbContact.NickName, Usr.tbUser.UserName, Subject.tbSubject.AccountName, invoice_address.Address AS InvoiceAddress, 
							 delivery_address.Address AS DeliveryAddress, sales_order.AccountCode, sales_order.ProjectNotes, sales_order.ProjectTitle, sales_order.ObjectCode, sales_order.ActionOn, Object.tbObject.UnitOfMeasure, 
...
AS
	SELECT        purchase_order.ProjectCode, purchase_order.ContactName, Subject.tbContact.NickName, Usr.tbUser.UserName, Subject.tbSubject.AccountName, invoice_address.Address AS InvoiceAddress, 
							 delivery_address.Address AS DeliveryAddress, purchase_order.AccountCode, purchase_order.ProjectNotes, purchase_order.ObjectCode, purchase_order.ActionOn, Object.tbObject.UnitOfMeasure, 
	...
	FROM            Usr.tbUser INNER JOIN
							 ...
							 Subject.tbContact ON purchase_order.AccountCode = Subject.tbContact.AccountCode AND purchase_order.ContactName = Subject.tbContact.ContactName
...
AS
SELECT        purchase_enquiry.ProjectCode, purchase_enquiry.ContactName, Subject.tbContact.NickName, Usr.tbUser.UserName, Subject.tbSubject.AccountName, Subject.tbAddress.Address AS InvoiceAddress, 
                         Subject_tbAddress_1.Address AS DeliveryAddress, purchase_enquiry.AccountCode, purchase_enquiry.ProjectNotes, purchase_enquiry.ObjectCode, purchase_enquiry.ActionOn, Object.tbObject.UnitOfMeasure, 
...
FROM            Usr.tbUser INNER JOIN
                         ...
                         App.tbTaxCode ON purchase_enquiry.TaxCode = App.tbTaxCode.TaxCode LEFT OUTER JOIN
                         Subject.tbContact ON purchase_enquiry.AccountCode = Subject.tbContact.AccountCode AND purchase_enquiry.ContactName = Subject.tbContact.ContactName
WHERE EXISTS (SELECT * FROM App.tbDocSpool AS doc WHERE DocTypeCode = 2 AND UserName = SUSER_SNAME() AND purchase_enquiry.ProjectCode = doc.DocumentNumber);
go
...
AS
	SELECT        Project.tbChangeLog.LogId, Project.tbChangeLog.ProjectCode, Project.tbChangeLog.ChangedOn, Subject.tbTransmitStatus.TransmitStatusCode, Subject.tbTransmitStatus.TransmitStatus, Subject.tbSubject.AccountCode, Subject.tbSubject.AccountName, 
	...
	FROM            Project.tbChangeLog INNER JOIN
							 ...
							 Subject.tbSubject ON Project.tbChangeLog.AccountCode = Subject.tbSubject.AccountCode INNER JOIN
...
AS
	...
	(
		SELECT Project.ObjectCode, Project.AccountCode, ProjectCode, ActionOn, Quantity, UnitCharge, CashPolarityCode
	...
	(
		SELECT ObjectCode, AccountCode, ProjectCode, ActionOn, CASE CashPolarityCode WHEN 0 THEN 1 ELSE 0 END SupplyOrder, CAST(0 AS bit) IsAllocation, UnitCharge,
			CASE CashPolarityCode
	...
	(
		SELECT ObjectCode, RowNumber, AccountCode, ProjectCode, IsAllocation, CashPolarityCode, UnitCharge, ActionOn, Quantity, Balance,
			CASE WHEN 
	...
	SELECT CAST(ROW_NUMBER() OVER (ORDER BY SvD_scheduled.ObjectCode, RowNumber) AS int) AllocationId, SvD_scheduled.ObjectCode, Object.ObjectDescription, AccountCode, IsAllocation, ProjectCode, SvD_scheduled.CashPolarityCode, polarity.CashPolarity, SvD_scheduled.UnitCharge, ActionOn, Quantity, CAST(Balance AS decimal(18,2)) Balance,
...
AS
	SELECT        Project.tbAllocationEvent.ContractAddress, Project.tbAllocationEvent.LogId, Project.tbAllocationEvent.EventTypeCode, Project.tbAllocationEvent.ProjectStatusCode, Project.tbAllocationEvent.ActionOn, Project.tbAllocationEvent.UnitCharge, 
							 ...
							 Project.tbStatus.ProjectStatus, Project.tbAllocation.AccountCode, Subject.tbSubject.AccountName, Object.tbMirror.ObjectCode, Project.tbAllocation.AllocationCode, Project.tbAllocation.AllocationDescription, Project.tbAllocation.ProjectCode, 
	...
	FROM            Project.tbAllocationEvent INNER JOIN
							 ...
							 Subject.tbSubject ON Project.tbAllocation.AccountCode = Subject.tbSubject.AccountCode AND Project.tbAllocation.AccountCode = Subject.tbSubject.AccountCode INNER JOIN
...
AS
	...
	(
		...
		FROM ancestors JOIN Subject.tbAccountKey nspace ON ancestors.CashAccountCode = nspace.CashAccountCode AND ancestors.Ancestor = nspace.HDPath
	), namespaced AS
	(
	...
	(
		SELECT namespaced.CashAccountCode, account.CoinTypeCode, namespaced.ChildHDPath HDPath, 
			...
			KeyLevel
		FROM namespaced
			JOIN Subject.tbAccount account ON namespaced.CashAccountCode = account.CashAccountCode
			JOIN  Subject.tbAccountKey ON namespaced.CashAccountCode = Subject.tbAccountKey.CashAccountCode 
...
go
PRINT N'Creating View [Subject].[vwAccountLookupAll]...';
...
AS
	...
	(
		SELECT        AccountCode, COUNT(ProjectCode) AS ProjectCount
		FROM            Project.tbProject
		WHERE        (ProjectStatusCode = 1)
		GROUP BY AccountCode
	)
	SELECT        o.AccountCode, o.AccountName, ISNULL(Project_count.ProjectCount, 0) AS Projects, o.SubjectTypeCode, Subject.tbType.SubjectType, Subject.tbType.CashPolarityCode, o.SubjectStatusCode, 
	...
	FROM            Subject.tbSubject AS o 
		...
		LEFT OUTER JOIN Project_count ON o.AccountCode = Project_count.AccountCode
go
...
AS
    ...
    SELECT Subject.tbContact.ContactName, Subject.tbSubject.AccountCode, COALESCE(ContactCount.Projects, 0) Projects, Subject.tbContact.PhoneNumber, Subject.tbContact.HomeNumber, Subject.tbContact.MobileNumber,  
                              Subject.tbContact.EmailAddress, Subject.tbSubject.AccountName, Subject.tbType.SubjectType, Subject.tbStatus.SubjectStatus, Subject.tbContact.NameTitle, Subject.tbContact.NickName, Subject.tbContact.JobTitle, 
                              Subject.tbContact.Department, Subject.tbContact.Information, Subject.tbContact.InsertedBy, Subject.tbContact.InsertedOn
     FROM            Subject.tbSubject INNER JOIN
                              Subject.tbType ON Subject.tbSubject.SubjectTypeCode = Subject.tbType.SubjectTypeCode INNER JOIN
                              Subject.tbStatus ON Subject.tbSubject.SubjectStatusCode = Subject.tbStatus.SubjectStatusCode INNER JOIN
                              Subject.tbContact ON Subject.tbSubject.AccountCode = Subject.tbContact.AccountCode LEFT OUTER JOIN
...
go
PRINT N'Creating View [Subject].[vwAccountSources]...';
...
go
PRINT N'Creating View [Subject].[vwAccountLookup]...';
...
AS
	...
	(
		...
		FROM Cash.tbPayment 
			JOIN Subject.tbAccount ON Cash.tbPayment.CashAccountCode = Subject.tbAccount.CashAccountCode
...
AS
	SELECT        Invoice.tbInvoice.AccountCode, tbInvoiceProject.InvoiceNumber, tbInvoiceProject.ProjectCode, Project.tbProject.ContactName, Invoice.tbInvoice.InvoicedOn, tbInvoiceProject.Quantity, tbInvoiceProject.InvoiceValue, tbInvoiceProject.TaxValue, 
							 tbInvoiceProject.CashCode, tbInvoiceProject.TaxCode, Invoice.tbStatus.InvoiceStatus, Project.tbProject.ProjectNotes, Cash.tbCode.CashDescription, Invoice.tbInvoice.InvoiceStatusCode, Project.tbProject.ProjectTitle, Subject.tbSubject.AccountName, 
...
AS
	SELECT        Invoice.tbMirrorEvent.ContractAddress, Invoice.tbMirror.AccountCode, Subject.tbSubject.AccountName, Invoice.tbMirror.InvoiceNumber, Invoice.tbMirrorEvent.LogId, Invoice.tbMirrorEvent.EventTypeCode, App.tbEventType.EventType, 
	...
	FROM            Invoice.tbMirrorEvent INNER JOIN
							 ...
							 Subject.tbSubject ON Invoice.tbMirror.AccountCode = Subject.tbSubject.AccountCode AND Invoice.tbMirror.AccountCode = Subject.tbSubject.AccountCode AND Invoice.tbMirror.AccountCode = Subject.tbSubject.AccountCode AND 
							 Invoice.tbMirror.AccountCode = Subject.tbSubject.AccountCode AND Invoice.tbMirror.AccountCode = Subject.tbSubject.AccountCode AND Invoice.tbMirror.AccountCode = Subject.tbSubject.AccountCode;
go
...
AS
SELECT        Invoice.tbMirror.ContractAddress, Invoice.tbMirror.AccountCode, Subject.tbSubject.AccountName, CASE WHEN tbMirrorReference.ContractAddress IS NULL THEN CAST(0 AS BIT) ELSE CAST(1 AS BIT) END AS IsMirrored, 
...
FROM            Invoice.tbMirror INNER JOIN
                         ...
                         Subject.tbSubject ON Invoice.tbMirror.AccountCode = Subject.tbSubject.AccountCode LEFT OUTER JOIN
...
AS
	...
	FROM Invoice.tbMirrorProject invoice_Project
		...
		JOIN Project.tbAllocation alloc ON alloc.AccountCode = invoice.AccountCode AND alloc.ProjectCode = invoice_Project.ProjectCode
		JOIN Object.tbMirror mirror ON alloc.AccountCode = mirror.AccountCode AND alloc.AllocationCode = mirror.AllocationCode
	UNION
...
AS
	SELECT        Invoice.tbChangeLog.LogId, Invoice.tbInvoice.AccountCode, Subject.tbSubject.AccountName, Invoice.tbInvoice.InvoiceNumber, Invoice.tbInvoice.InvoiceTypeCode, Invoice.tbType.InvoiceType, Invoice.tbChangeLog.InvoiceStatusCode, 
	...
	FROM            Invoice.tbChangeLog INNER JOIN
							 ...
							 Subject.tbSubject ON Invoice.tbInvoice.AccountCode = Subject.tbSubject.AccountCode AND Invoice.tbInvoice.AccountCode = Subject.tbSubject.AccountCode INNER JOIN
...
AS
	SELECT Invoice.tbInvoice.InvoiceNumber, Invoice.tbInvoice.AccountCode, Subject.tbSubject.AccountName, Invoice.tbInvoice.InvoiceTypeCode, Invoice.tbInvoice.InvoiceStatusCode, Invoice.tbStatus.InvoiceStatus, 
	...
	FROM            Invoice.tbInvoice INNER JOIN
							 Invoice.tbStatus ON Invoice.tbInvoice.InvoiceStatusCode = Invoice.tbStatus.InvoiceStatusCode INNER JOIN
							 Invoice.tbType ON Invoice.tbInvoice.InvoiceTypeCode = Invoice.tbType.InvoiceTypeCode INNER JOIN
							 Subject.tbSubject ON Invoice.tbInvoice.AccountCode = Subject.tbSubject.AccountCode
...
AS
	SELECT        Invoice.tbEntry.UserId, Usr.tbUser.UserName, Invoice.tbEntry.AccountCode, Subject.tbSubject.AccountName, Invoice.tbEntry.CashCode, Cash.tbCode.CashDescription, Invoice.tbEntry.InvoiceTypeCode, Invoice.tbType.InvoiceType, 
	...
	FROM            Invoice.tbEntry INNER JOIN
							 Subject.tbSubject ON Invoice.tbEntry.AccountCode = Subject.tbSubject.AccountCode INNER JOIN
...
AS
SELECT TOP 100 PERCENT  Invoice.tbInvoice.InvoiceNumber, Invoice.tbInvoice.AccountCode, Subject.tbSubject.AccountName, Invoice.tbInvoice.InvoiceTypeCode, Invoice.tbInvoice.InvoiceStatusCode, Invoice.tbStatus.InvoiceStatus, 
...
AS
SELECT        sales_invoice.InvoiceNumber, Invoice.tbType.InvoiceType, sales_invoice.InvoiceStatusCode, Usr.tbUser.UserName, sales_invoice.AccountCode, Subject.tbSubject.AccountName, Invoice.tbStatus.InvoiceStatus, 
...
FROM            Invoice.tbInvoice AS sales_invoice INNER JOIN
                         ...
                         Subject.tbSubject ON sales_invoice.AccountCode = Subject.tbSubject.AccountCode INNER JOIN
...
AS
	...
	FROM            Invoice.tbInvoice INNER JOIN
							 Invoice.tbStatus ON Invoice.tbInvoice.InvoiceStatusCode = Invoice.tbStatus.InvoiceStatusCode INNER JOIN
							 Invoice.tbType ON Invoice.tbInvoice.InvoiceTypeCode = Invoice.tbType.InvoiceTypeCode INNER JOIN
							 Subject.tbSubject ON Invoice.tbInvoice.AccountCode = Subject.tbSubject.AccountCode LEFT OUTER JOIN
...
AS
SELECT        debit_note.Printed, debit_note.InvoiceNumber, Invoice.tbType.InvoiceType, debit_note.InvoiceStatusCode, Usr.tbUser.UserName, debit_note.AccountCode, Subject.tbSubject.AccountName, Invoice.tbStatus.InvoiceStatus, 
...
FROM            Invoice.tbInvoice AS debit_note INNER JOIN
                         ...
                         Subject.tbSubject ON debit_note.AccountCode = Subject.tbSubject.AccountCode INNER JOIN
...
AS
SELECT        credit_note.InvoiceNumber, credit_note.Printed, Invoice.tbType.InvoiceType, credit_note.InvoiceStatusCode, Usr.tbUser.UserName, credit_note.AccountCode, Subject.tbSubject.AccountName, Invoice.tbStatus.InvoiceStatus, 
...
FROM            Invoice.tbInvoice AS credit_note INNER JOIN
                         ...
                         Subject.tbSubject ON credit_note.AccountCode = Subject.tbSubject.AccountCode INNER JOIN
...
AS
	SELECT        credit_note.InvoiceNumber, Invoice.tbType.InvoiceType, credit_note.InvoiceStatusCode, Usr.tbUser.UserName, credit_note.AccountCode, Subject.tbSubject.AccountName, Invoice.tbStatus.InvoiceStatus, credit_note.InvoicedOn, 
...
WITH invoice AS 
(
	SELECT        sales_invoice.InvoiceNumber, Invoice.tbType.InvoiceType, sales_invoice.InvoiceStatusCode, Usr.tbUser.UserName, sales_invoice.AccountCode, Subject.tbSubject.AccountName, 
	...
	WHERE        EXISTS
								(SELECT        UserName, DocTypeCode, DocumentNumber, SpooledOn
									FROM            App.tbDocSpool AS doc
									WHERE        (DocTypeCode = 4) AND (UserName = SUSER_SNAME()) AND (sales_invoice.InvoiceNumber = DocumentNumber))
	GROUP BY sales_invoice.InvoiceNumber, Invoice.tbType.InvoiceType, sales_invoice.InvoiceStatusCode, Usr.tbUser.UserName, sales_invoice.AccountCode, Subject.tbSubject.AccountName, 
...
AS
	...
	(
		SELECT       (SELECT TOP (1) p.StartOn FROM App.tbYearPeriod p WHERE (p.StartOn <= Invoice.tbInvoice.InvoicedOn) ORDER BY p.StartOn DESC) AS StartOn,  
				Invoice.tbInvoice.InvoiceNumber, Invoice.tbInvoice.AccountCode, Invoice.tbInvoice.InvoiceTypeCode, Invoice.tbInvoice.InvoiceStatusCode, 
								 ...
								 Invoice.tbInvoice.Printed, Subject.tbSubject.AccountName, Usr.tbUser.UserName, Invoice.tbInvoice.UserId, Invoice.tbStatus.InvoiceStatus, Invoice.tbType.CashPolarityCode, Invoice.tbType.InvoiceType
		FROM            Invoice.tbInvoice INNER JOIN
								 Subject.tbSubject ON Invoice.tbInvoice.AccountCode = Subject.tbSubject.AccountCode INNER JOIN
								 Invoice.tbType ON Invoice.tbInvoice.InvoiceTypeCode = Invoice.tbType.InvoiceTypeCode INNER JOIN
								 Invoice.tbStatus ON Invoice.tbInvoice.InvoiceStatusCode = Invoice.tbStatus.InvoiceStatusCode INNER JOIN
	...
	SELECT COALESCE(StartOn, CAST(getdate() as date)) StartOn, InvoiceNumber, AccountCode, InvoiceTypeCode, InvoiceStatusCode, InvoicedOn, DueOn, ExpectedOn,
		...
		PaymentTerms, Notes, Printed, AccountName, UserName, UserId, InvoiceStatus, CashPolarityCode, InvoiceType
	FROM register;
go
...
AS
	SELECT (SELECT TOP (1) p.StartOn FROM App.tbYearPeriod p WHERE (p.StartOn <= Invoice.tbInvoice.InvoicedOn) ORDER BY p.StartOn DESC) AS StartOn,  
			Invoice.tbInvoice.InvoiceNumber, InvoiceProject.ProjectCode, Project.ProjectTitle, Cash.tbCode.CashCode, Cash.tbCode.CashDescription, 
							 InvoiceProject.TaxCode, App.tbTaxCode.TaxDescription, Invoice.tbInvoice.AccountCode, Invoice.tbInvoice.InvoiceTypeCode, Invoice.tbInvoice.InvoiceStatusCode, 
							 ...
							 Subject.tbSubject.AccountName, Usr.tbUser.UserName, Invoice.tbInvoice.UserId, Invoice.tbStatus.InvoiceStatus, Invoice.tbType.CashPolarityCode, Invoice.tbType.InvoiceType
	FROM            Invoice.tbInvoice INNER JOIN
							 Subject.tbSubject ON Invoice.tbInvoice.AccountCode = Subject.tbSubject.AccountCode INNER JOIN
							 Invoice.tbType ON Invoice.tbInvoice.InvoiceTypeCode = Invoice.tbType.InvoiceTypeCode INNER JOIN
							 Invoice.tbStatus ON Invoice.tbInvoice.InvoiceStatusCode = Invoice.tbStatus.InvoiceStatusCode INNER JOIN
...
AS
	SELECT        Cash.tbTaxType.TaxTypeCode, Cash.tbTaxType.TaxType, Cash.tbTaxType.CashCode, Cash.tbCode.CashDescription, Cash.tbTaxType.MonthNumber, App.tbMonth.[MonthName], Cash.tbTaxType.RecurrenceCode, 
							 App.tbRecurrence.Recurrence, Cash.tbTaxType.AccountCode, Subject.tbSubject.AccountName, Cash.tbTaxType.OffsetDays
	FROM            Cash.tbTaxType INNER JOIN
							 ...
							 Subject.tbSubject ON Cash.tbTaxType.AccountCode = Subject.tbSubject.AccountCode;
go
...
AS
	...
	(
		SELECT  Subject.tbAccount.CashAccountCode, Subject.tbAccount.CashAccountName, Subject.tbAccount.CurrentBalance
		FROM            Subject.tbAccount LEFT OUTER JOIN
								 Cash.tbCode ON Subject.tbAccount.CashCode = Cash.tbCode.CashCode 
		WHERE        (Subject.tbAccount.AccountCode <> (SELECT AccountCode FROM App.tbOptions))
	...
	(
		SELECT  0 AS RowNumber, Subject.AccountCode, Subject.AccountName, TransactOn, CashEntryTypeCode, ReferenceCode, 
					PayOut, PayIn, NULL AS CashCode, NULL AS CashDescription
		FROM opening_balance
			JOIN Subject.tbSubject Subject ON opening_balance.AccountCode = Subject.AccountCode
...
AS
	SELECT TOP (1) Subject.tbSubject.AccountName, Subject.tbAddress.Address, Subject.tbSubject.PhoneNumber, Subject.tbSubject.EmailAddress, Subject.tbSubject.WebSite, Subject.tbSubject.Logo, Usr.tbUser.UserName, Usr.tbUser.LogonName, Usr.tbUser.Avatar, 
...
AS
	WITH candidates AS
	(
		SELECT DISTINCT Project.tbAllocation.AccountCode, Subject.tbSubject.AccountName, Project.tbAllocation.AllocationCode, Project.tbAllocation.AllocationDescription, Project.tbAllocation.CashPolarityCode, Cash.tbPolarity.CashPolarity, Project.tbAllocation.UnitCharge, Project.tbAllocation.UnitOfMeasure
		FROM            Project.tbAllocation 
			...
			INNER JOIN Subject.tbSubject ON Project.tbAllocation.AccountCode = Subject.tbSubject.AccountCode 
			LEFT OUTER JOIN Object.tbMirror ON Project.tbAllocation.AccountCode = Object.tbMirror.AccountCode AND Project.tbAllocation.AllocationCode = Object.tbMirror.AllocationCode
	...
	SELECT CAST(ROW_NUMBER() OVER (ORDER BY AccountCode, AllocationCode) AS int) CandidateId,
		candidates.AccountCode, candidates.AccountName, candidates.AllocationCode, candidates.AllocationDescription, candidates.CashPolarityCode, candidates.CashPolarity, candidates.UnitCharge, candidates.UnitOfMeasure,
...
CREATE   VIEW Subject.vwAddresses
  AS
SELECT     TOP 100 PERCENT Subject.tbSubject.AccountName, Subject.tbAddress.Address, Subject.tbSubject.SubjectTypeCode, Subject.tbSubject.SubjectStatusCode, 
...
FROM         Subject.tbSubject INNER JOIN
                      ...
                      Subject.vwMailContacts ON Subject.tbSubject.AccountCode = Subject.vwMailContacts.AccountCode
ORDER BY Subject.tbSubject.AccountName
go
...
AS
	...
	FROM            Subject.vwAssetStatement AS asset INNER JOIN
							 Subject.tbSubject AS o ON o.AccountCode = asset.AccountCode INNER JOIN
...
AS
	...
	FROM  Subject.vwAssetStatement AS asset_statement INNER JOIN
			Subject.tbSubject AS account ON asset_statement.AccountCode = account.AccountCode INNER JOIN
...
AS
	...
	(
		SELECT AccountCode, ABS(Balance) Balance, CASE WHEN Balance > 0 THEN 0 ELSE 1 END CashPolarityCode 
		...
		FROM nonzero_balance_Subjects
			CROSS APPLY
				(
					...
					WHERE (AccountCode = nonzero_balance_Subjects.AccountCode 
...
AS
	WITH register AS
	(
		SELECT     StartOn, InvoiceNumber, ProjectCode, CashCode, CashDescription, TaxCode, TaxDescription, AccountCode, InvoiceTypeCode, InvoiceStatusCode, 
							  InvoicedOn, DueOn, ExpectedOn, CAST(Quantity as float) Quantity, CAST(InvoiceValue as float) InvoiceValue, CAST(TaxValue as float) TaxValue, PaymentTerms, Printed, AccountName, UserName, UserId, InvoiceStatus, CashPolarityCode, 
							  InvoiceType, CAST(1 as bit) IsProject, NULL ItemReference
		FROM         Invoice.vwRegisterProjects
		UNION
		SELECT     StartOn, InvoiceNumber, ProjectCode, CashCode, CashDescription, TaxCode, TaxDescription, AccountCode, InvoiceTypeCode, InvoiceStatusCode, 
							  InvoicedOn, DueOn, ExpectedOn, CAST(0 as float) Quantity, CAST(InvoiceValue as float) InvoiceValue, CAST(TaxValue as float) TaxValue, PaymentTerms, Printed, AccountName, UserName, UserId, InvoiceStatus, CashPolarityCode, 
							  InvoiceType, CAST(0 as bit) IsProject, ItemReference
		FROM         Invoice.vwRegisterItems
	)
	SELECT StartOn, InvoiceNumber, ProjectCode, CashCode, CashDescription, TaxCode, TaxDescription, AccountCode, InvoiceTypeCode, InvoiceStatusCode, 
		InvoicedOn, DueOn, ExpectedOn, PaymentTerms, Printed, AccountName, UserName, UserId, InvoiceStatus, CashPolarityCode, InvoiceType,
...
FROM            Cash.vwTaxVatAccruals AS vat_accruals INNER JOIN
                         ...
                         Subject.tbSubject ON Project.tbProject.AccountCode = Subject.tbSubject.AccountCode AND Project.tbProject.AccountCode = Subject.tbSubject.AccountCode AND Project.tbProject.AccountCode = Subject.tbSubject.AccountCode AND 
                         Project.tbProject.AccountCode = Subject.tbSubject.AccountCode AND Project.tbProject.AccountCode = Subject.tbSubject.AccountCode AND Project.tbProject.AccountCode = Subject.tbSubject.AccountCode INNER JOIN
...
AS
	SELECT     App.tbYear.YearNumber, CONCAT(App.tbYear.Description, ' ', App.tbMonth.MonthName) AS YearPeriod, Cash.vwTaxCorpAccruals.StartOn, Project.tbProject.ProjectCode, Project.tbProject.AccountCode, Subject.tbSubject.AccountName, 
...
AS
	SELECT        App.tbYearPeriod.YearNumber, CONCAT(App.tbMonth.MonthName, SPACE(1), YEAR(App.tbYearPeriod.StartOn)) AS PeriodName, Invoice.vwRegisterDetail.StartOn, Invoice.vwRegisterDetail.InvoiceNumber, 
							 Invoice.vwRegisterDetail.ProjectCode, Invoice.vwRegisterDetail.CashCode, Invoice.vwRegisterDetail.CashDescription, Invoice.vwRegisterDetail.TaxCode, Invoice.vwRegisterDetail.AccountCode, Invoice.vwRegisterDetail.InvoicedOn, 
...
AS
	SELECT        CONCAT(App.tbMonth.MonthName, SPACE(1), YEAR(App.tbYearPeriod.StartOn)) AS PeriodName, App.tbYearPeriod.YearNumber, Invoice.vwRegisterDetail.StartOn, Invoice.vwRegisterDetail.InvoiceNumber, 
							 ...
							 Invoice.vwRegisterDetail.AccountName, Invoice.vwRegisterDetail.UserName, Invoice.vwRegisterDetail.InvoiceStatus, Invoice.vwRegisterDetail.CashPolarityCode, Invoice.vwRegisterDetail.InvoiceType
	FROM            Invoice.vwRegisterDetail INNER JOIN
							 App.tbYearPeriod ON Invoice.vwRegisterDetail.StartOn = App.tbYearPeriod.StartOn INNER JOIN
							 App.tbYear ON App.tbYearPeriod.YearNumber = App.tbYear.YearNumber INNER JOIN
							 App.tbMonth ON App.tbYearPeriod.MonthNumber = App.tbMonth.MonthNumber
...
AS
	SELECT        StartOn, InvoiceNumber, ProjectCode, CashCode, CashDescription, TaxCode, TaxDescription, AccountCode, InvoiceTypeCode, InvoiceStatusCode, InvoicedOn, InvoiceValue, TaxValue, PaymentTerms, Printed, AccountName, 
...
AS
	...
	(
		...
		FROM         Cash.tbPayment payment INNER JOIN Subject.tbAccount ON payment.CashAccountCode = Subject.tbAccount.CashAccountCode
	...
	(
		SELECT     Cash.tbPayment.PaymentCode, Cash.tbPayment.CashAccountCode, Usr.tbUser.UserName, Cash.tbPayment.AccountCode, 
							  Subject.tbSubject.AccountName, Cash.tbPayment.CashCode, Cash.tbCode.CashDescription, App.tbTaxCode.TaxDescription, 
		...
		FROM         Cash.tbPayment INNER JOIN
							  Usr.tbUser ON Cash.tbPayment.UserId = Usr.tbUser.UserId INNER JOIN
							  Subject.tbSubject ON Cash.tbPayment.AccountCode = Subject.tbSubject.AccountCode LEFT OUTER JOIN
							  App.tbTaxCode ON Cash.tbPayment.TaxCode = App.tbTaxCode.TaxCode LEFT OUTER JOIN
							  Cash.tbCode ON Cash.tbPayment.CashCode = Cash.tbCode.CashCode
	)
...
AS
	...
	(
		...
		FROM Cash.vwAccountStatement account_statement
			JOIN Subject.tbAccount account ON account_statement.CashAccountCode = account.CashAccountCode
	...
	(
		SELECT CashAccountCode, CashAccountName, CashPolarityCode
	...
	SELECT asset_accounts.CashAccountCode AssetCode, CashAccountName AssetName, CashPolarityCode, 4 AssetTypeCode, StartOn, Balance
	FROM asset_base
...
CREATE VIEW Invoice.vwRegisterExpenses
 AS
	SELECT     Invoice.vwRegisterProjects.StartOn, Invoice.vwRegisterProjects.InvoiceNumber, Invoice.vwRegisterProjects.ProjectCode, App.tbYearPeriod.YearNumber, 
						  ...
						  Invoice.vwRegisterProjects.AccountCode, Invoice.vwRegisterProjects.InvoiceTypeCode, Invoice.vwRegisterProjects.InvoiceStatusCode, Invoice.vwRegisterProjects.InvoicedOn, 
						  Invoice.vwRegisterProjects.InvoiceValue, Invoice.vwRegisterProjects.TaxValue, 
						  Invoice.vwRegisterProjects.PaymentTerms, Invoice.vwRegisterProjects.Printed, Invoice.vwRegisterProjects.AccountName, Invoice.vwRegisterProjects.UserName, 
...
AS
	...
	FROM            Cash.tbChange AS change INNER JOIN
							 Subject.tbAccountKey AS account_key ON change.CashAccountCode = account_key.CashAccountCode AND change.HDPath = account_key.HDPath INNER JOIN
							 Subject.tbAccount AS account ON account_key.CashAccountCode = account.CashAccountCode
...
go
CREATE   FUNCTION Invoice.fnEditProjects (@InvoiceNumber nvarchar(20), @AccountCode nvarchar(10))
RETURNS TABLE
AS
	RETURN 
	(		
		...
		WHERE        (Project.tbProject.AccountCode = @AccountCode) AND (Project.tbProject.ProjectStatusCode = 1 OR
...
AS
	...
	(		
		...
		WHERE        (Invoice.tbInvoice.AccountCode = @AccountCode) AND (Invoice.tbInvoice.InvoiceTypeCode = 0) AND (InvoiceEditProjects.ProjectCode IS NULL)
		ORDER BY Invoice.tbInvoice.InvoicedOn DESC
	);
go
...
AS
	...
	(
		WITH tx AS
		(
			SELECT        change.CashAccountCode, Subject.tbAccount.CoinTypeCode, change.PaymentAddress, change.HDPath, change.ChangeTypeCode, change_type.ChangeType, change.ChangeStatusCode, change_status.ChangeStatus, 
			...
			FROM            Cash.tbTx AS tx INNER JOIN
                         ...
                         Subject.tbAccount ON change.CashAccountCode = Subject.tbAccount.CashAccountCode
...
AS
	...
	(
		...
		(
			SELECT        Cash.tbChangeReference.PaymentAddress, Cash.tbChangeReference.InvoiceNumber, Invoice.tbInvoice.AccountCode, Subject.tbSubject.AccountName, Invoice.tbType.InvoiceType, 
		...
		(
			SELECT Cash.fnChangeKeyPath(cash_account.CoinTypeCode, key_namespace.HDPath.ToString(), change.ChangeTypeCode, AddressIndex)  FullHDPath, 
				...
				change.Note, account_reference.InvoiceNumber, account_reference.AccountCode, account_reference.AccountName, account_reference.InvoiceType, account_reference.InvoiceStatus, account_reference.CashPolarityCode,
			...
			FROM  key_namespace 
				JOIN Subject.tbAccount AS cash_account ON key_namespace.CashAccountCode = cash_account.CashAccountCode AND key_namespace.CashAccountCode = cash_account.CashAccountCode 
...
AS
	RETURN
	(
		SELECT change.CashAccountCode, Subject.fnAccountKeyNamespace(account_key.CashAccountCode, account_key.HDPath) AS KeyNamespace, 
...
AS
	SELECT        Project.tbProject.ProjectCode, Project.tbProject.UserId, Project.tbProject.AccountCode, Project.tbProject.ContactName, Project.tbProject.ObjectCode, Project.tbProject.ProjectTitle, Project.tbProject.ProjectStatusCode, Project.tbProject.ActionById, 
							 ...
							 Usr.tbUser.UserName AS ActionName, Subject.tbSubject.AccountName, SubjectStatus.SubjectStatus, Subject.tbType.SubjectType, CASE WHEN Cash.tbCategory.CategoryCode IS NULL 
	...
	FROM            Usr.tbUser INNER JOIN
							 ...
							 Project.tbProject ON Subject.tbSubject.AccountCode = Project.tbProject.AccountCode ON ProjectStatus.ProjectStatusCode = Project.tbProject.ProjectStatusCode ON Usr.tbUser.UserId = Project.tbProject.ActionById INNER JOIN
							 Usr.tbUser AS tbUser_1 ON Project.tbProject.UserId = tbUser_1.UserId INNER JOIN
...
AS
	SELECT        Project.vwProjects.AccountCode, Project.vwProjects.ProjectCode, Project.vwProjects.UserId, Project.vwProjects.ContactName, Project.vwProjects.ObjectCode, Project.vwProjects.ProjectTitle, Project.vwProjects.ProjectStatusCode, Project.vwProjects.ActionById, 
							 ...
							 Project.vwProjects.AccountName, Project.vwProjects.SubjectStatus, Project.vwProjects.SubjectType, Project.vwProjects.CashPolarityCode, Cash.tbPolarity.CashPolarity
...
AS
	SELECT TOP 100 PERCENT  ProjectCode, AccountCode, ContactName, ObjectCode, ActionOn, ActionedOn, Quantity, UnitCharge, TotalCharge, ProjectTitle, ProjectNotes, CashDescription, ActionName, OwnerName, ProjectStatus, InsertedBy, 
...
AS
	SELECT TOP 100 PERCENT ProjectCode, AccountCode, ContactName, ObjectCode, ActionOn, ActionedOn, ProjectTitle, Quantity, UnitCharge, TotalCharge, ProjectNotes, CashDescription, ActionName, OwnerName, ProjectStatus, InsertedBy, 
							 InsertedOn, UpdatedBy, UpdatedOn, ProjectStatusCode
	FROM            Project.vwProjects
	WHERE        (ProjectStatusCode = 1 OR
...
AS
	...
	(
		SELECT Project.tbProject.ProjectCode AS ReferenceCode, 
			Project.tbProject.AccountCode, Project.tbProject.PaymentOn AS TransactOn, 
	...
	(
		...
		FROM    Project.vwCostSetProjects cost_set INNER JOIN	Project.tbProject quotes ON cost_set.ProjectCode = quotes.ProjectCode INNER JOIN
				Subject.tbSubject ON quotes.AccountCode = Subject.tbSubject.AccountCode INNER JOIN
...
AS
	SELECT Project.vwProjects.ProjectCode, Project.vwProjects.ActionOn, Project.vwProjects.ObjectCode, Project.vwProjects.ActionById, Project.vwProjects.BucketId, Project.vwProjects.ProjectTitle, Project.vwProjects.AccountCode, 
							 ...
							 Project.vwProjects.UpdatedBy, Project.vwProjects.UpdatedOn, Project.vwProjects.AccountName, Project.vwProjects.ActionName, Project.vwProjects.Period, Project.vwProjects.Printed, Project.vwProjects.Spooled, Project.vwProjects.RowVer
...
AS
	SELECT        Project.vwProjects.ProjectCode, Project.vwProjects.ActionOn, Project.vwProjects.ObjectCode, Project.vwProjects.ActionById, Project.vwProjects.BucketId, Project.vwProjects.AccountCode, Project.vwProjects.ProjectTitle, Project.vwProjects.ContactName, 
...
AS
	SELECT        Project.vwProjects.ProjectCode, Project.vwProjects.ObjectCode, Project.vwProjects.ProjectStatusCode, Project.vwProjects.ActionOn, Project.vwProjects.ActionById, Project.vwProjects.ProjectTitle, Project.vwProjects.Period, Project.vwProjects.BucketId, 
							 Project.vwProjects.AccountCode, Project.vwProjects.ContactName, Project.vwProjects.ProjectStatus, Project.vwProjects.ProjectNotes, Project.vwProjects.ActionedOn, Project.vwProjects.OwnerName, Project.vwProjects.CashCode, 
							 ...
							 Subject.tbAddress.Address AS ToAddress, Project.vwProjects.Printed, Project.vwProjects.InsertedBy, Project.vwProjects.InsertedOn, Project.vwProjects.UpdatedBy, Project.vwProjects.UpdatedOn, Project.vwProjects.AccountName, 
...
SELECT        Project.tbOp.ProjectCode, Project.tbProject.ObjectCode, Project.tbOp.OperationNumber, Project.vwOpBucket.Period, Project.vwOpBucket.BucketId, Project.tbOp.UserId, Project.tbOp.SyncTypeCode, Project.tbOp.OpStatusCode, 
                         ...
                         Project.tbProject.ProjectTitle, Project.tbProject.ProjectStatusCode, Project.tbStatus.ProjectStatus, Project.tbProject.ActionOn, Project.tbProject.Quantity, Cash.tbCode.CashDescription, Project.tbProject.TotalCharge, Project.tbProject.AccountCode, 
                         Subject.tbSubject.AccountName, Project.tbOp.RowVer AS OpRowVer, Project.tbProject.RowVer AS ProjectRowVer
...
AS
	SELECT        App.tbYear.YearNumber, App.tbYear.Description, App.tbMonth.MonthName, Subject.tbSubject.AccountCode, Subject.tbSubject.AccountName, Subject.tbType.SubjectType, Cash.tbPolarity.CashPolarity, Cash.tbAssetType.AssetTypeCode, 
	...
	FROM            Subject.vwAssetBalances INNER JOIN
							 ...
							 Subject.tbSubject ON Subject.vwAssetBalances.AccountCode = Subject.tbSubject.AccountCode INNER JOIN
...
go
CREATE   PROCEDURE Object.proc_NetworkUpdated(@AccountCode nvarchar(10), @AllocationCode nvarchar(50))
AS
	SET NOCOUNT, XACT_ABORT ON;
...
AS
	SET NOCOUNT ON;
	BEGIN TRY
		If EXISTS(SELECT     Subject.tbSubject.AddressCode, Subject.tbSubject.AccountCode
				  FROM         Subject.tbSubject INNER JOIN
										inserted AS i ON Subject.tbSubject.AccountCode = i.AccountCode
...
go
CREATE   PROCEDURE Subject.proc_AccountKeyRename(@CashAccountCode nvarchar (10), @OldKeyName nvarchar(50), @NewKeyName nvarchar(50), @KeyNamespace nvarchar(1024) output)
AS
	SET NOCOUNT, XACT_ABORT OFF;
...
AS
	...
	BEGIN TRY
		...
		DECLARE @ParentId hierarchyid = (SELECT HDPath FROM Subject.tbAccountKey WHERE CashAccountCode = @CashAccountCode AND KeyName = @ParentName);
		...
		IF (App.fnParsePrimaryKey(@ChildName) <> 0 AND CHARINDEX('.', @ChildName) = 0)
			BEGIN
				...
				SET @ChildHDPath = ( SELECT CONCAT('44/', CoinTypeCode, '/0', @ChildHDPath) FROM Subject.tbAccount WHERE CashAccountCode = @CashAccountCode)
...
CREATE PROCEDURE Subject.proc_DefaultTaxCode 
  ...
  AS
	...
	END CATCH
go
PRINT N'Creating Procedure [Subject].[proc_DefaultAccountCode]...';
...
AS
	...
	BEGIN TRY
		...
		BEGIN
			EXEC Subject.proc_DefaultAccountCode @AccountName = @DummyAccount, @AccountCode = @CashAccountCode OUTPUT
			INSERT INTO Subject.tbAccount (CashAccountCode, AccountCode, CashAccountName, AccountTypeCode, CashCode)
