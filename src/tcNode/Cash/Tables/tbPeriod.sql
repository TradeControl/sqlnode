CREATE TABLE [Cash].[tbPeriod] (
    ...
    [ForecastValue] MONEY         CONSTRAINT [DF_Cash_tbPeriod_ForecastValue] DEFAULT ((0)) NOT NULL,
    [ForecastTax]   MONEY         CONSTRAINT [DF_Cash_tbPeriod_ForecastTax] DEFAULT ((0)) NOT NULL,
    [InvoiceValue]  MONEY         CONSTRAINT [DF_Cash_tbPeriod_InvoiceValue] DEFAULT ((0)) NOT NULL,
    [InvoiceTax]    MONEY         CONSTRAINT [DF_Cash_tbPeriod_InvoiceTax] DEFAULT ((0)) NOT NULL,
    [Note]          NTEXT         NULL,
