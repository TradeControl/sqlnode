CREATE TABLE [Task].[tbQuote] (
    ...
    [Quantity]        DECIMAL    CONSTRAINT [DF_Task_tbQuote_Quantity] DEFAULT ((0)) NOT NULL,
    [TotalPrice]      DECIMAL         CONSTRAINT [DF_Task_tbQuote_TotalPrice] DEFAULT ((0)) NOT NULL,
    [RunOnQuantity]   DECIMAL    CONSTRAINT [DF_Task_tbQuote_RunOnQuantity] DEFAULT ((0)) NOT NULL,
    [RunOnPrice]      MONEY         CONSTRAINT [DF_Task_tbQuote_RunOnPrice] DEFAULT ((0)) NOT NULL,
    [RunBackQuantity] DECIMAL    CONSTRAINT [DF_Task_tbQuote_RunBackQuantity] DEFAULT ((0)) NOT NULL,
    [RunBackPrice]    DECIMAL    CONSTRAINT [DF_Task_tbQuote_RunBackPrice] DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [PK_Task_tbQuote] PRIMARY KEY CLUSTERED ([TaskCode] ASC, [Quantity] ASC) WITH (FILLFACTOR = 90),
