CREATE TABLE [Task].[tbQuote] (
    ...
    [Quantity]        FLOAT (53)    CONSTRAINT [DF_Task_tbQuote_Quantity] DEFAULT ((0)) NOT NULL,
    [TotalPrice]      MONEY         CONSTRAINT [DF_Task_tbQuote_TotalPrice] DEFAULT ((0)) NOT NULL,
    [RunOnQuantity]   FLOAT (53)    CONSTRAINT [DF_Task_tbQuote_RunOnQuantity] DEFAULT ((0)) NOT NULL,
    [RunOnPrice]      MONEY         CONSTRAINT [DF_Task_tbQuote_RunOnPrice] DEFAULT ((0)) NOT NULL,
    [RunBackQuantity] FLOAT (53)    CONSTRAINT [DF_Task_tbQuote_RunBackQuantity] DEFAULT ((0)) NOT NULL,
    [RunBackPrice]    FLOAT (53)    CONSTRAINT [DF_Task_tbQuote_RunBackPrice] DEFAULT ((0)) NOT NULL,
