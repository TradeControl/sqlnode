CREATE TABLE [Project].[tbProject] (
    ...
    CONSTRAINT [Object_tb_FK00] FOREIGN KEY ([ObjectCode]) REFERENCES [Object].[tbObject] ([ObjectCode]) ON UPDATE CASCADE,
    CONSTRAINT [Object_tb_FK01] FOREIGN KEY ([ProjectStatusCode]) REFERENCES [Project].[tbStatus] ([ProjectStatusCode]),
    CONSTRAINT [Object_tb_FK02] FOREIGN KEY ([AccountCode]) REFERENCES [Subject].[tbSubject] ([AccountCode]) ON UPDATE CASCADE,
