...
(
    SELECT
        ...
        COALESCE(registeredAddress.AddressCode, tradingAddress.AddressCode) AS StatutoryAddressCode,
        COALESCE(registeredAddress.Address, tradingAddress.Address) AS StatutoryAddress,
        subject.PhoneNumber,
        ...
        CONVERT(binary(8), COALESCE(registeredAddress.RowVer, tradingAddress.RowVer)) AS StatutoryAddressRowVer,
