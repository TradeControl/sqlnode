...
ALTER TABLE Task.tbTask DROP 
	CONSTRAINT DF_Task_tb_UnitCharge,
	COLUMN	UnitCharge;
go
ALTER TABLE Task.tbTask WITH NOCHECK ADD
	UnitCharge decimal(18, 7) NOT NULL CONSTRAINT DF_Task_tb_UnitCharge DEFAULT (0);
go
UPDATE Task.tbTask
...
AS
	 ...
	 BEGIN TRY
		...
		DECLARE @CurrentAccount nvarchar(10) = (SELECT CashAccountCode FROM Org.tbAccount accounts JOIN Cash.tbCode cash_codes ON accounts.CashCode = cash_codes.CashCode);
		DECLARE @ReserveAccount nvarchar(10) = (SELECT CashAccountCode FROM Org.tbAccount WHERE (CashCode IS NULL) AND (DummyAccount = 0));
		...
		VALUES (CONCAT(@UserId, '_20190008_120000'), @UserId, 1, 'CDCUST', @CurrentAccount, '103', 'T1', '20190228', 1200.0000, 0.0000, 200.0000, 0.0000, CONCAT('010000.', @UserId))
		, (CONCAT(@UserId, '_20190008_120001'), @UserId, 1, 'CDCUST', @CurrentAccount, '103', 'T1', '20190329', 1200.0000, 0.0000, 200.0000, 0.0000, CONCAT('010001.', @UserId))
		, (CONCAT(@UserId, '_20190008_120002'), @UserId, 1, 'CDCUST', @CurrentAccount, '103', 'T1', '20190430', 1200.0000, 0.0000, 200.0000, 0.0000, CONCAT('010002.', @UserId))
		, (CONCAT(@UserId, '_20190008_120003'), @UserId, 1, 'CDCUST', @CurrentAccount, '103', 'T1', '20190531', 1200.0000, 0.0000, 200.0000, 0.0000, CONCAT('010003.', @UserId))
		, (CONCAT(@UserId, '_20190008_120004'), @UserId, 1, 'CDCUST', @CurrentAccount, '103', 'T1', '20190628', 1200.0000, 0.0000, 200.0000, 0.0000, CONCAT('010004.', @UserId))
		...
		, (CONCAT(@UserId, '_20190022_120002'), @UserId, 1, 'CDCUST', @CurrentAccount, '103', 'T1', '20190731', 1200.0000, 0.0000, 200.0000, 0.0000, CONCAT('010011.', @UserId))
