...
AS
	 ...
	 BEGIN TRY
		...
		VALUES (CONCAT('010000.', @UserId), CONCAT(@UserId, '_10007'), 5000, 0.0000, 2000, 400, 2000, 400, '103', 'T1')
		, (CONCAT('010001.', @UserId), CONCAT(@UserId, '_10008'), 5000, 0.0000, 2000, 400, 2000, 400, '103', 'T1')
		, (CONCAT('010002.', @UserId), CONCAT(@UserId, '_10009'), 5000, 0.0000, 2000, 400, 2000, 400, '103', 'T1')
		, (CONCAT('010003.', @UserId), CONCAT(@UserId, '_10010'), 5000, 0.0000, 2000, 400, 2000, 400, '103', 'T1')
		, (CONCAT('010004.', @UserId), CONCAT(@UserId, '_10011'), 5000, 0.0000, 2000, 400, 2000, 400, '103', 'T1')
		, (CONCAT('010006.', @UserId), CONCAT(@UserId, '_10017'), 5000000, 0.0000, 18500.0000, 3700.0000, 18500.0000, 3700.0000, '103', 'T1')
		, (CONCAT('010011.', @UserId), CONCAT(@UserId, '_10012'), 5000, 0.0000, 2000, 400, 2000, 400, '103', 'T1')
		...
		VALUES (CONCAT(@UserId, '_20190008_120000'), @UserId, 1, 'CDCUST', @CurrentAccount, '103', 'T1', '20190228', 2400.0000, 0.0000, 400.0000, 0.0000, CONCAT('010000.', @UserId))
		, (CONCAT(@UserId, '_20190008_120001'), @UserId, 1, 'CDCUST', @CurrentAccount, '103', 'T1', '20190329', 2400.0000, 0.0000, 400.0000, 0.0000, CONCAT('010001.', @UserId))
		, (CONCAT(@UserId, '_20190008_120002'), @UserId, 1, 'CDCUST', @CurrentAccount, '103', 'T1', '20190430', 2400.0000, 0.0000, 400.0000, 0.0000, CONCAT('010002.', @UserId))
		, (CONCAT(@UserId, '_20190008_120003'), @UserId, 1, 'CDCUST', @CurrentAccount, '103', 'T1', '20190531', 2400.0000, 0.0000, 400.0000, 0.0000, CONCAT('010003.', @UserId))
		, (CONCAT(@UserId, '_20190008_120004'), @UserId, 1, 'CDCUST', @CurrentAccount, '103', 'T1', '20190628', 2400.0000, 0.0000, 400.0000, 0.0000, CONCAT('010004.', @UserId))
		, (CONCAT(@UserId, '_20190008_120005'), @UserId, 1, 'SUPTWO', @CurrentAccount, '200', 'T0', '20190228', 0.0000, 650.0000, 0.0000, 0.0000, CONCAT('030000.', @UserId))
		, (CONCAT(@UserId, '_20190008_120006'), @UserId, 1, 'TRACOM', @CurrentAccount, '200', 'T1', '20190228', 0.0000, 180.0000, 0.0000, 30.0000, CONCAT('030001.', @UserId))
		, (CONCAT(@UserId, '_20190008_120007'), @UserId, 1, 'SUPTWO', @CurrentAccount, '200', 'T0', '20190329', 0.0000, 650.0000, 0.0000, 0.0000, CONCAT('030002.', @UserId))
		, (CONCAT(@UserId, '_20190008_120008'), @UserId, 1, 'TRACOM', @CurrentAccount, '200', 'T1', '20190329', 0.0000, 180.0000, 0.0000, 30.0000, CONCAT('030003.', @UserId))
		, (CONCAT(@UserId, '_20190008_120009'), @UserId, 1, 'SUPTWO', @CurrentAccount, '200', 'T0', '20190430', 0.0000, 650.0000, 0.0000, 0.0000, CONCAT('030004.', @UserId))
		, (CONCAT(@UserId, '_20190008_120010'), @UserId, 1, 'TRACOM', @CurrentAccount, '200', 'T1', '20190430', 0.0000, 180.0000, 0.0000, 30.0000, CONCAT('030005.', @UserId))
		, (CONCAT(@UserId, '_20190008_120011'), @UserId, 1, 'SUPTWO', @CurrentAccount, '200', 'T0', '20190430', 0.0000, 650.0000, 0.0000, 0.0000, CONCAT('030006.', @UserId))
		, (CONCAT(@UserId, '_20190008_120012'), @UserId, 1, 'TRACOM', @CurrentAccount, '200', 'T1', '20190531', 0.0000, 180.0000, 0.0000, 30.0000, CONCAT('030007.', @UserId))
		, (CONCAT(@UserId, '_20190008_120013'), @UserId, 1, 'SUPTWO', @CurrentAccount, '200', 'T0', '20190628', 0.0000, 650.0000, 0.0000, 0.0000, CONCAT('030008.', @UserId))
		, (CONCAT(@UserId, '_20190008_120014'), @UserId, 1, 'TRACOM', @CurrentAccount, '200', 'T1', '20190628', 0.0000, 180.0000, 0.0000, 30.0000, CONCAT('030009.', @UserId))
		, (CONCAT(@UserId, '_20190008_120015'), @UserId, 1, 'BUSOWN', @CurrentAccount, '205', 'T0', '20190131', 0.0000, 84.7000, 0.0000, 0.8000, null)
		, (CONCAT(@UserId, '_20190008_120016'), @UserId, 1, 'BUSOWN', @CurrentAccount, '402', 'NI1', '20190131', 0.0000, 1000.0000, 0.0000, 0.0000, null)
		, (CONCAT(@UserId, '_20190008_120017'), @UserId, 1, 'BUSOWN', @CurrentAccount, '402', 'NI1', '20190228', 0.0000, 1000.0000, 0.0000, 0.0000, null)
		, (CONCAT(@UserId, '_20190008_120018'), @UserId, 1, 'BUSOWN', @CurrentAccount, '402', 'NI1', '20190329', 0.0000, 1000.0000, 0.0000, 0.0000, null)
		, (CONCAT(@UserId, '_20190008_120019'), @UserId, 1, 'BUSOWN', @CurrentAccount, '402', 'NI1', '20190430', 0.0000, 1000.0000, 0.0000, 0.0000, null)
		, (CONCAT(@UserId, '_20190008_120020'), @UserId, 1, 'BUSOWN', @CurrentAccount, '402', 'NI1', '20190531', 0.0000, 1000.0000, 0.0000, 0.0000, null)
		, (CONCAT(@UserId, '_20190008_120021'), @UserId, 1, 'BUSOWN', @CurrentAccount, '402', 'NI1', '20190628', 0.0000, 1000.0000, 0.0000, 0.0000, null)
		, (CONCAT(@UserId, '_20190008_120022'), @UserId, 1, 'BUSOWN', @CurrentAccount, '205', 'T0', '20190228', 0.0000, 118.4500, 0.0000, 0.0000, 'Monthly expenses')
		, (CONCAT(@UserId, '_20190008_120023'), @UserId, 1, 'BUSOWN', @CurrentAccount, '205', 'T0', '20190329', 0.0000, 105.1000, 0.0000, 0.0000, 'Monthly expenses')
		, (CONCAT(@UserId, '_20190008_120024'), @UserId, 1, 'SUPTWO', @CurrentAccount, '200', 'T1', '20190430', 0.0000, 7200.0000, 0.0000, 1200.0000, CONCAT('030017.', @UserId))
		, (CONCAT(@UserId, '_20190008_120025'), @UserId, 1, 'BUSOWN', @CurrentAccount, '205', 'T0', '20190430', 0.0000, 169.0000, 0.0000, 0.0000, 'Monthly expenses')
		, (CONCAT(@UserId, '_20190008_120026'), @UserId, 1, 'EFCUST', @CurrentAccount, '103', 'T1', '20190518', 22200.0000, 0.0000, 3700.0000, 0.0000, null)
		, (CONCAT(@UserId, '_20190008_120027'), @UserId, 1, 'THEPAP', @CurrentAccount, '200', 'T1', '20190518', 0.0000, 11700.0000, 0.0000, 1950.0000, null)
		, (CONCAT(@UserId, '_20190008_120028'), @UserId, 1, 'BUSOWN', @CurrentAccount, '205', 'T0', '20190708', 0.0000, 215.3500, 0.0000, 3.6000, 'Monthly expenses')
		, (CONCAT(@UserId, '_20190008_120029'), @UserId, 1, 'BUSOWN', @CurrentAccount, '205', 'T0', '20190708', 0.0000, 203.4000, 0.0000, 1.0000, 'Monthly expenses')
		, (CONCAT(@UserId, '_20190019_120000'), @UserId, 1, 'TELPRO', @CurrentAccount, '202', 'T1', '20190125', 0.0000, 48.0000, 0.0000, 8.0000, CONCAT('030026.', @UserId))
		, (CONCAT(@UserId, '_20190019_120001'), @UserId, 1, 'TELPRO', @CurrentAccount, '202', 'T1', '20190226', 0.0000, 47.5200, 0.0000, 7.9200, CONCAT('030027.', @UserId))
		, (CONCAT(@UserId, '_20190019_120002'), @UserId, 1, 'TELPRO', @CurrentAccount, '202', 'T1', '20190326', 0.0000, 51.7400, 0.0000, 8.6200, CONCAT('030028.', @UserId))
		, (CONCAT(@UserId, '_20190019_120003'), @UserId, 1, 'TELPRO', @CurrentAccount, '202', 'T1', '20190426', 0.0000, 52.2200, 0.0000, 8.7000, CONCAT('030029.', @UserId))
		, (CONCAT(@UserId, '_20190019_120004'), @UserId, 1, 'TELPRO', @CurrentAccount, '202', 'T1', '20190526', 0.0000, 51.0200, 0.0000, 8.5000, CONCAT('030030.', @UserId))
		, (CONCAT(@UserId, '_20190019_120005'), @UserId, 1, 'TELPRO', @CurrentAccount, '202', 'T1', '20190626', 0.0000, 49.3800, 0.0000, 8.2300, CONCAT('030031.', @UserId))
		, (CONCAT(@UserId, '_20190022_120000'), @UserId, 1, 'TELPRO', @CurrentAccount, '202', 'T1', '20190726', 0.0000, 48.0000, 0.0000, 8.0000, CONCAT('030033.', @UserId))
		, (CONCAT(@UserId, '_20190022_120001'), @UserId, 1, 'BUSOWN', @CurrentAccount, '402', 'NI1', '20190731', 0.0000, 1000.0000, 0.0000, 0.0000, CONCAT('030035.', @UserId))
		, (CONCAT(@UserId, '_20190022_120002'), @UserId, 1, 'CDCUST', @CurrentAccount, '103', 'T1', '20190731', 2400.0000, 0.0000, 400.0000, 0.0000, CONCAT('010011.', @UserId))
		, (CONCAT(@UserId, '_20190022_120003'), @UserId, 1, 'SUPTWO', @CurrentAccount, '200', 'T0', '20190731', 0.0000, 650.0000, 0.0000, 0.0000, CONCAT('030036.', @UserId))
		, (CONCAT(@UserId, '_20190022_120004'), @UserId, 1, 'TRACOM', @CurrentAccount, '200', 'T1', '20190731', 0.0000, 180.0000, 0.0000, 30.0000, CONCAT('030037.', @UserId))
		, (CONCAT(@UserId, '_20190022_120005'), @UserId, 1, 'SUNSUP', @CurrentAccount, '209', 'T1', '20190702', 0.0000, 64.8000, 0.0000, 10.8000, null)
		, (CONCAT(@UserId, '_20190608_030639'), @UserId, 1, 'HOME', @ReserveAccount, '305', 'N/A', '20190101', 15000.0000, 0.0000, 0.0000, 0.0000, 'Opening balance')
		, (CONCAT(@UserId, '_20190708_030716'), @UserId, 1, 'HOME', @ReserveAccount, '303', 'N/A', '20190415', 0.0000, 5000.0000, 0.0000, 0.0000, 'Transfer to current account')
		, (CONCAT(@UserId, '_20190708_030747'), @UserId, 1, 'HOME', @CurrentAccount, '305', 'N/A', '20190415', 5000.0000, 0.0000, 0.0000, 0.0000, 'Transfer from Reserve Account')
		, (CONCAT(@UserId, '_20191822_121834'), @UserId, 2, 'HOME', @CurrentAccount, '303', 'N/A', '20190831', 0.0000, 5000.0000, 0.0000, 0.0000, 'Transfer to Reserve account')
		, (CONCAT(@UserId, '_20191822_121848'), @UserId, 2, 'HOME', @ReserveAccount, '305', 'N/A', '20190831', 5000.0000, 0.0000, 0.0000, 0.0000, 'Transfer from current account')
		, (CONCAT(@UserId, '_20192408_042438'), @UserId, 1, 'HOME', @CurrentAccount, '303', 'N/A', '20190601', 0.0000, 5000.0000, 0.0000, 0.0000, 'Transfer to Reserve Account')
		, (CONCAT(@UserId, '_20192508_042502'), @UserId, 1, 'HOME', @ReserveAccount, '305', 'N/A', '20190601', 5000.0000, 0.0000, 0.0000, 0.0000, 'Transfer from Current Account')
		, (CONCAT(@UserId, '_20194708_014729'), @UserId, 1, 'HOME', @CurrentAccount, '305', 'N/A', '20190101', 10000.0000, 0.0000, 0.0000, 0.0000, 'Opening Balance')
		, (CONCAT(@UserId, '_20195222_125225'), @UserId, 1, 'HOME', @CurrentAccount, '303', 'N/A', '20190731', 0.0000, 1000.0000, 0.0000, 0.0000, 'Transfer to Reserve account')
		, (CONCAT(@UserId, '_20195322_125307'), @UserId, 1, 'HOME', @ReserveAccount, '305', 'N/A', '20190731', 1000.0000, 0.0000, 0.0000, 0.0000, 'Transfer from current account')
		;
